...
- Optionally (configurable for performance, enabled by default), columns beneath leaf canopies are processed as well. While disabled, nothing beneath canopies changes, and snow accumulation and icicles there are inactive.
